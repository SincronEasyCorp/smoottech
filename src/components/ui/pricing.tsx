...
export function Pricing({
  ...
  return <div className="container py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        damping: 30,
        delay: index * 0.1
      }} className={cn(`rounded-2xl border-[1px] p-8 bg-white/5 backdrop-blur-sm text-center flex flex-col justify-between relative`, plan.isPopular ? "border-[rgba(109,141,176,1)] border-2" : "border-white/20", "min-h-[600px]")}>
            {plan.isPopular && <div className="absolute top-0 right-0 bg-[rgba(109,141,176,1)] py-1 px-3 rounded-bl-xl rounded-tr-xl flex items-center">
            ...
            <div className="flex-1 flex flex-col">
              ...
              {!isMonthly && <div className="bg-[rgba(109,141,176,0.2)] rounded-lg p-3 mb-6">
                  <p className="text-white text-sm font-semibold">
                    💰 Migração do sistema antigo GRATUITA
                  </p>
                </div>}

              {isMonthly && plan.migrationFee && <div className="bg-white/10 rounded-lg p-3 mb-6">
            ...
            variant: "outline"
          }), "group relative w-full gap-2 overflow-hidden text-lg font-semibold tracking-tighter", "transform-gpu ring-offset-current transition-all duration-300 ease-out hover:ring-2 hover:ring-[rgba(109,141,176,1)] hover:ring-offset-1", plan.isPopular ? "bg-[rgba(109,141,176,1)] text-white hover:bg-[rgba(89,121,156,1)] border-[rgba(109,141,176,1)]" : "bg-transparent text-white hover:bg-[rgba(109,141,176,1)] border-white/30")}>
                {plan.buttonText}
              </button>
