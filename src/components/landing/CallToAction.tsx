...
export const CallToAction = () => {
  ...
  return <section className="bg-[rgba(33,37,41,1)] py-20 px-6 md:px-16 relative overflow-hidden">
      {/* Background graphics */}
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          once: true
            ...
            <div className="flex flex-wrap gap-4">
              <motion.button onClick={handleContact} className="bg-[rgba(109,141,176,1)] hover:bg-[rgba(89,121,156,1)] text-white font-medium px-6 py-3 rounded-md transition-all" whileHover={{
              scale: 1.03
            }} whileTap={{
              scale: 0.98
            }}>
          ...
          once: true
            ...
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/7ca8def902c57abb5ed46812411d9e0e88bd1356e4e1269efcc5f981beb94395?placeholderIfAbsent=true" alt="Business transformation" className="max-w-full h-auto" />
          </motion.div>
        </div>
      </div>
    </section>;
