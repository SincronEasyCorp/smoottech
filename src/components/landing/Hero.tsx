...
export const Hero = () => {
  return (
    <section className="bg-[rgba(56,70,116,1)] flex w-full flex-col items-center pt-16 pb-12 px-6 md:px-16 max-w-full relative overflow-hidden">
      ...
      <ContainerScroll
        titleComponent={
          <motion.div 
            className="max-w-4xl mx-auto text-center z-10 py-2 px-4"
