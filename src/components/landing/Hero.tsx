...
export const Hero = () => {
  return (
    <section className="bg-[rgba(56,70,116,1)] flex w-full flex-col items-center pt-4 pb-4 px-6 md:px-16 max-w-full relative overflow-hidden">
      ...
      <ContainerScroll
        titleComponent={
          <motion.div 
            className="max-w-4xl mx-auto text-center z-10 py-0 px-2"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
          >
            <h1 className="text-[24px] md:text-[30px] lg:text-[36px] text-white font-bold text-center tracking-[-0.68px] leading-tight mb-2">
              Tecnologia inovadora para a <span className="text-[rgba(109,141,176,1)]">gestão do seu negócio</span>
            </h1>
            
            <p className="mt-1 text-white/80 text-base md:text-lg max-w-2xl mx-auto">
